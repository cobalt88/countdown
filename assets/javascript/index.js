(function() {
  ...
  var 
  // mo = document.getElementById('months').getContext('2d'),
  ...
  function set() {
    ...
    var today = new Date(),
      ...
      let negMonths = 5 - today.getMonth();
    ...
    // monthDisplay.textContent = 5 - negMonths;

    clear(d);
    setTrack(d);
    setTime(d, grad.getDate(), today.getDate(), daysThisMonth);
    dayDisplay.textContent = negMonths * 30 + negDays;
